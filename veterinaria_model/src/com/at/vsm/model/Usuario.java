...
public class Usuario {
    ...
    public Usuario(int idUsuario, String nombreUsuario, String contrasenia, String rol, String fotografia, String token, String dateLastToken) {
        this.idUsuario = idUsuario;
        this.nombreUsuario = nombreUsuario;
        this.contrasenia = contrasenia;
        this.rol = rol;
    ...
    public String toString() {
        return "Usuario{" + "idUsuario=" + idUsuario + ", nombreUsuario=" + nombreUsuario + ", contrasenia=" + contrasenia + ", rol=" + rol + ", fotografia=" + fotografia + ", token=" + token + ", dateLastToken=" + dateLastToken + '}';
    }
