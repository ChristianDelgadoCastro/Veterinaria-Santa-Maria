...
public class ControllerCliente {
    ...
    public int insert(Cliente c) throws Exception{
        ...
        cstmt.setString(11, c.getUsuario().getFotografia());
    ...
    public List<Cliente> search(String datoBusqueda) throws Exception{
        
        //Nuestra query
        String sql = "CALL buscarClientes('"+datoBusqueda+"');";
    ...
    //getAll para todos los clientes
    ...
    private Cliente fill(ResultSet rs) throws Exception{
        ...
        c.getUsuario().setFotografia(rs.getString("fotografia"));
