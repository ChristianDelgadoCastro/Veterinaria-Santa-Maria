...
public class ControllerEmpleado {
    ...
    public int insert(Empleado e) throws Exception{
        ...
        //2. Datos de Usuario
        cstmt.setString(9, e.getUsuario().getNombreUsuario());
        cstmt.setString(10, e.getUsuario().getContrasenia());
        cstmt.setString(11, e.getUsuario().getFotografia());
        
        //3. Datos de Empleado
        cstmt.setString(12, e.getPuesto());
    ...
    public void update(Empleado e) throws Exception{
        ...
        //4. ID'S Afectadas
        cstmt.setInt(13, e.getUsuario().getIdUsuario());
        cstmt.setInt(14, e.getPersona().getIdPersona());
    ...
    //getAll para todos los empleados
    ...
    public List<Empleado> search(String datoBusqueda) throws Exception{
        
        //Nuestra query
        String sql = "CALL buscarEmpleados('"+datoBusqueda+"');";
        ...
        //los resultados de la consulta lo mandamos a un objeto de tipo empleado 
        //y mandarlo a un arraylist (una lista para los compas)
